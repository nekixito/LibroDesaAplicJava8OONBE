...
public class frmCasaCambio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Casa de cambios con getters y setters");
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
        ...
        objC.setSoles(Double.parseDouble(txtSoles.getText()));
        objC.setDolares(Double.parseDouble(txtDolares.getText()));
        objC.setMarcos(Double.parseDouble(txtMarcos.getText()));
        ...
        moR.addElement("----------------------");
        moR.addElement("MONTO SOLES: " + String.format("%.2f", objC.getSoles()));
        moR.addElement("MONTO DOLARES: " + String.format("%.2f", objC.getDolares()));
        moR.addElement("MONTO MARCOS: " + String.format("%.2f", objC.getMarcos()));
        moR.addElement("----------------------");
